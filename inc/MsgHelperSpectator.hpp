...
class MsgServerSpectator
{
	...
	static int CellContent(SocketW& client /*, const CellContent& */);
	...
	static int PlayerInventory(SocketW& client, unsigned int playerNum /* const InventoryContent& */);
	...
	static int PlayerIncantation(SocketW& client, unsigned int width, unsigned int height, unsigned int playerNum /* List of playerNum*/);
	static int IncantationDone(SocketW& client, unsigned int width, unsigned int height, int result);
	...
	static int GameEnd(SocketW& client);
	static int ServerMessage(SocketW& client);
